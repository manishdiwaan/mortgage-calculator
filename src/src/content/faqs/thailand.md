---
country: "thailand"
metaTitle: "Thailand Mortgage & Property FAQs 2026 | URMortgage"
metaDescription: "Answers to common questions about mortgages and property buying in Thailand."
faqs:
  - question: "How much down payment do I need to buy a house in Thailand?"
    ...
    category: "financing"
  - question: "What is a good mortgage rate in Thailand?"
    answer: "Rates are influenced by the Bank of Thailand benchmark rate and vary by lender. Compare rates across multiple lenders using our mortgage calculator."
    category: "financing"
  ...
  - question: "Should I use a mortgage broker?"
    ...
    category: "financing"
  - question: "How do I buy a house in Thailand?"
  ...
  - question: "Can foreigners buy property in Thailand?"
    ...
    category: "buying-process"
  - question: "What is transfer fee in Thailand?"
  ...
  - question: "What ongoing costs should I budget for?"
    ...
    category: "costs"
  - question: "Is property a good investment in Thailand?"
    ...
    category: "investment"
  - question: "Should I rent or buy in Thailand?"
  ...
  - question: "How do interest rate changes affect my mortgage?"
    answer: "Variable rate mortgages are affected by Bank of Thailand rate changes. Fixed rate borrowers are not affected until their fixed term expires."
    category: "general"
  - question: "Can foreigners own land in Thailand?"
    answer: "Foreigners generally cannot own land freehold in Thailand under the Land Code Act. The main exception is condominium units, where foreigners can hold freehold title. Alternatives include long-term leasehold, usufruct, or superficies rights, though these carry legal limitations compared to outright ownership."
    category: "legal"
  - question: "What is the foreign ownership quota for Thai condominiums?"
    answer: "Under the Thai Condominium Act, foreign nationals can collectively own no more than 49% of the total sellable area in any single condominium project. Once this quota is reached, additional foreigners can only purchase on the Thai quota side, typically requiring a Thai company or spouse structure. Always verify the current foreign quota availability with the juristic person office before purchasing."
    category: "legal"
  - question: "What is the Thai Condominium Act and why does it matter?"
    answer: "The Thai Condominium Act B.E. 2522 governs the registration, management, and ownership of condominium buildings in Thailand. It sets out rules for juristic person management, common area fees, voting rights, and the 49% foreign ownership quota. Understanding this Act is essential for any foreigner purchasing a condo unit in Thailand."
    category: "legal"
  - question: "What is a Chanote title deed and why is it important?"
    answer: "A Chanote, or Nor Sor 4 Jor, is the highest and most secure form of land title in Thailand, confirmed by GPS-surveyed boundaries. It provides the clearest proof of ownership and is the preferred title for any property purchase or mortgage. Always insist on Chanote title to minimize boundary disputes and legal complications."
    category: "legal"
  - question: "What is the difference between a Chanote and a Nor Sor 3 Gor title?"
    answer: "A Chanote (Nor Sor 4 Jor) has GPS-verified boundaries and offers the strongest ownership rights, while a Nor Sor 3 Gor is a confirmed certificate of use with less precise boundaries. Nor Sor 3 Gor can be upgraded to Chanote but carries slightly more risk of boundary disputes. Most banks and serious buyers prefer Chanote title for transactions."
    category: "legal"
  - question: "What is a 30-year leasehold and how does it work for foreigners in Thailand?"
    answer: "A registered leasehold gives a foreigner the right to use and occupy land or property for up to 30 years, registered at the Land Office. Many developers offer a 30+30 or 30+30+30 year structure through contract renewal clauses, but only the initial 30-year term is legally enforceable in Thai courts. The renewal periods are contractual promises that cannot be guaranteed under current Thai law."
    category: "legal"
  - question: "Is a 30-year lease renewal actually enforceable in Thailand?"
    answer: "Under Thai law, a lease registered at the Land Office can only be enforceable for a maximum of 30 years at a time. Renewal clauses for subsequent 30-year periods are contractual obligations between parties but are not automatically enforceable as real rights against future owners. If the landowner sells or passes away, the new owner is not legally bound to honor renewal clauses, making this a significant risk for foreign lessees."
    category: "legal"
  - question: "What is a usufruct right in Thailand and how can foreigners use it?"
    answer: "A usufruct (Sithi Kep Kin) grants a foreigner the right to use and enjoy the fruits of a property, such as rental income, for their lifetime or up to 30 years when registered at the Land Office. It provides stronger protection than a simple lease agreement and can be registered against the title deed. However, it does not grant ownership and ends upon the usufructuary's death if granted for lifetime."
    category: "legal"
  - question: "What is a superficies right and when should foreigners consider it?"
    answer: "A superficies right (Sithi Kep Kin Bon Din) allows a foreigner to own a structure built on someone else's land, separating building ownership from land ownership. It can be registered at the Land Office for up to 30 years or for the lifetime of the holder. This is useful for foreigners who build a home on Thai-owned land, such as a spouse's land, providing legal protection for the building investment."
    category: "legal"
  - question: "What are the risks of putting land in a Thai spouse's name?"
