...
- question: "Qu'est-ce que la 'quotité hypothécaire' (LTV) et comment influence-t-elle mon crédit en Belgique ?"
  answer: "La quotité hypothécaire ou Loan-to-Value (LTV) représente le rapport entre le montant emprunté et la valeur vénale du bien. En Belgique, la Banque Nationale a imposé des limites prudentielles, notamment un LTV maximum de 90% pour les primo-accédants et 80% pour les investisseurs. Un LTV plus bas signifie généralement un meilleur taux d'int
```yaml
...
- question: "Comment calculer précisément les droits d'enregistrement sur une vente immobilière en Belgique ?"
  answer: "Les droits d'enregistrement sont calculés sur la base imposable, qui est le plus élevé entre le prix de vente déclaré et la
```yaml
